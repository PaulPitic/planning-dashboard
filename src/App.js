...
const areas = [
  ...
  },
  {
    ...
    color: "#3b82f6",
    items: [
      { key: "prep", label: "Trolley Prepper", slots: 2 },
  ...
  },
  {
    ...
    color: "#f97316",
    items: [
      { key: "doc", label: "Document Applier", slots: 2 },
      { key: "pal1", label: "Palletiser", slots: 3 },
      { key: "pal2", label: "Palletiser", slots: 3 },
      { key: "drop", label: "Trolley Dropper", slots: 1 },
      { key: "box", label: "Box Filler", slots: 1 },
    ],
  },
  {
    name: "VAS / Nester",
...
export default function App() {
  ...
  /* =====================================================
     CARD
  ===================================================== */
  function renderCard(item, color, options) {
